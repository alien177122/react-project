---
{
  "order": 231,
  "section": "svg",
  "path": "createmotionpath",
  "slug": "svg/createmotionpath",
  "url": "https://animejs.com/documentation/svg/createmotionpath",
  "title": "createMotionPath",
  "breadcrumb": [
    "SVG",
    "createMotionPath"
  ],
...
> Source: [https://animejs.com/documentation/svg/createmotionpath](https://animejs.com/documentation/svg/createmotionpath)
> Breadcrumb: SVG → createMotionPath
...
- [Tween parameter](https://animejs.com/documentation/animation/tween-parameters)
...
← Prev: **createDrawable** (`svg/createdrawable`) | Next: **Text** (`text`) →
