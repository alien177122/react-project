...
> Source: [https://animejs.com/documentation/draggable/draggable-properties](https://animejs.com/documentation/draggable/draggable-properties)
> Breadcrumb: Draggable → Draggable properties
...
← Prev: **refresh()** (`draggable/draggable-methods/refresh`) | Next: **Layout** (`layout`) →
