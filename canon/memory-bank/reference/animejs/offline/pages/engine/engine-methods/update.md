...
> Source: [https://animejs.com/documentation/engine/engine-methods/update](https://animejs.com/documentation/engine/engine-methods/update)
> Breadcrumb: Engine → Engine methods → update()
...
← Prev: **Engine methods** (`engine/engine-methods`) | Next: **pause()** (`engine/engine-methods/pause`) →
