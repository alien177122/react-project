---
{
  "order": 67,
  "section": "animation",
  "path": "tween-parameters/composition",
...
> Source: [https://animejs.com/documentation/animation/tween-parameters/composition](https://animejs.com/documentation/animation/tween-parameters/composition)
...
## Composition blend gotchas

Blending only works by playing **forward** two or more animations with composition `'blend'` simultaneously.

It is not currently possible to use composition `'blend'` with:
...
← Prev: **ease** (`animation/tween-parameters/ease`) | Next: **modifier** (`animation/tween-parameters/modifier`) →
