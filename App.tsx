...
function VolumeDonut() {
  ...
  // ⚡ Bolt: Memoize static dataset derivations (vol, total, segs, catArcs, catVols)
  // to avoid redundant O(N*M) recalculations and allocations during high-frequency hover re-renders.
  // computeMuscleVol relies purely on static module-level constants (EXERCISES, MUSCLE_CONTRIB), so [] is safe.
