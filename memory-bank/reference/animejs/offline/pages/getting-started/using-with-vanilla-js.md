...
> Source: [https://animejs.com/documentation/getting-started/using-with-vanilla-js](https://animejs.com/documentation/getting-started/using-with-vanilla-js)
> Breadcrumb: Getting started → Using with vanilla JS
...
← Prev: **Module imports** (`getting-started/module-imports`) | Next: **Using with React** (`getting-started/using-with-react`) →
