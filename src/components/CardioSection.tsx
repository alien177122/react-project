  ...
  return (
    <div className="ta-cardio">
      <aside className="ta-cardio-note" role="note">
        Аэробная активность и регулярное движение связаны со снижением смертности — это
        подтверждают крупные наблюдательные исследования. Проценты снижения риска показывают{' '}
      ...
      <aside className="ta-cardio-disclaimer" role="note">
        <strong>Ограничения.</strong> Видео не заменяет консультацию врача. Особая осторожность:
        ССЗ, аритмии, тяжёлая гипертония, ожирение, беременность, послеоперационный период. Начинай
        с минимального объёма.
      </aside>
    </div>
  )
}
