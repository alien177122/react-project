...
import { EXERCISES, WHEEL_ORDER, TYPE_COLORS, SHORT_NAMES, TYPE_LABELS } from '../data/exercises'
import { pol, donutArc } from '../utils/geometry'
...
// ============================================================
export default function ExerciseWheel({ value, onChange, savedExercises = [] }: { value: string; onChange: (key: string) => void; savedExercises?: SavedExercise[] }) {
