---
{
  "order": 152,
  "section": "events",
  "path": "onscroll/scrollobserver-callbacks/onenterbackward",
  "slug": "events/onscroll/scrollobserver-callbacks/onenterbackward",
  "url": "https://animejs.com/documentation/events/onscroll/scrollobserver-callbacks/onenterbackward",
...
> Source: [https://animejs.com/documentation/events/onscroll/scrollobserver-callbacks/onenterbackward](https://animejs.com/documentation/events/onscroll/scrollobserver-callbacks/onenterbackward)
> Breadcrumb: Events → onScroll → ScrollObserver callbacks → onEnterBackward
...
← Prev: **onEnterForward** (`events/onscroll/scrollobserver-callbacks/onenterforward`) | Next: **onLeave** (`events/onscroll/scrollobserver-callbacks/onleave`) →
