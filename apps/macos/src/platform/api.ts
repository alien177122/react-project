...
import type {FileWorkspaceResponse, UserData} from '@training/shared/types';
    ...
    ? input.exercises.flatMap(exercise => {
        ...
        const exerciseKey =
          typeof exercise.exerciseKey === 'string'
            ...
            : '';
        const date =
          typeof exercise.date === 'string' ? exercise.date.trim() : '';
        ...
        if (testWeight === null || testReps === null || oneRM === null) {
          return [];
        }
