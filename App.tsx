...
function VolumeDonut() {
  ...
  // Separate purely static computation to clarify dependency flow
  const vol = useMemo(() => computeMuscleVol(), [])

  // ⚡ Bolt: Consolidate multiple derived array and arc coordinate calculations into a single useMemo
  // to prevent redundant iterations and O(N) array recreation on high-frequency hover state updates.
