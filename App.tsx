...
function VolumeDonut() {
  ...
  // ⚡ Bolt: computeMuscleVol and related variables are completely static derivations from EXERCISES and MUSCLE_CONTRIB.
  // Wrapping them in useMemo with an empty dependency array avoids O(N*M) recalculations on every hover/render.
  const { vol, total, segs, catArcs, catVols } = useMemo(() => {
    ...
    return { vol, total, segs, catArcs, catVols }
  }, [])
