...
export const MTOR_VIDEO_CONTEXT = 'На странице Boosty с видео «Активация mTOR / Анаболический отклик (Биохакинг)» без транскрипта видны только интерфейс, комментарии и плеер. Само содержание ролика в текстовом виде не отображается, поэтому точные определения и закономерности нельзя честно извлечь без дополнительного материала.'

export const MTOR_REQUEST_OPTIONS = [
  {
    title: 'Вариант 1 — транскрипт видео',
    body: 'Лучший путь для точного конспекта: пришли полный транскрипт. Тогда можно разобрать термины, причинно-следственные связи и спорные формулировки без догадок.',
  },
  {
    title: 'Вариант 2 — аудио или видео файл',
    body: 'Если дашь сам файл, можно сначала сделать транскрипцию, затем выделить основные понятия и собрать поэтапный научный конспект для сайта.',
  },
  {
    title: 'Вариант 3 — ссылка на скачанное видео',
    body: 'Если ролик уже скачан, достаточно прямой ссылки на файл. После этого можно пройти тот же путь: транскрипция → термины → структурированный конспект.',
  },
]

export const MTOR_CONCEPTS = [
  {
    title: '1. Основное понятие: mTOR',
    definition: 'mTOR — это клеточный сигнальный белковый комплекс, регулирующий синтез белка, рост клеток и анаболические процессы.',
    pattern: 'Активация mTOR → увеличение синтеза белка → рост мышечной ткани.',
  },
  {
    title: '2. Анаболический отклик',
    definition: 'Анаболический отклик — увеличение скорости синтеза мышечного белка в ответ на стимул.',
    bullets: ['механическая нагрузка (силовая тренировка)', 'аминокислоты, особенно лейцин', 'инсулин', 'энергетический статус клетки'],
  },
  {
    title: '3. Антагонистическая система: AMPK',
    definition: 'AMPK — клеточный сенсор энергетического дефицита.',
    pattern: 'Если энергии мало → активируется AMPK → тормозит mTOR → снижается анаболизм.',
  },
  {
    title: '4. Лейциновый порог',
    definition: 'Лейциновый порог — минимальное количество аминокислоты лейцина, необходимое для заметного запуска mTOR.',
    pattern: 'Около 2–3 г лейцина за приём пищи → близкая к максимальной стимуляция синтеза белка.',
  },
  {
    title: '5. Анаболическое окно',
    definition: 'Это период после тренировки, когда мышцы особенно чувствительны к аминокислотам.',
    pattern: 'Тренировка → рост чувствительности мышц к белку → усиленный синтез белка.',
  },
  {
    title: '6. Питание и mTOR',
    definition: 'На сигналы роста сильнее всего влияют белок, отдельные аминокислоты и гормональные медиаторы.',
    bullets: ['белок, особенно лейцин', 'аргинин', 'инсулин', 'IGF-1'],
    pattern: 'Аминокислоты + механическая нагрузка → максимальный анаболический отклик.',
  },
  {
    title: '7. Тренировочный стимул',
    definition: 'Тренировочный стимул — механическое напряжение мышечных волокон, запускающее сигнальные пути адаптации.',
    pattern: 'Высокое напряжение → активация сигнальных путей → запуск mTOR.',
  },
  {
    title: '8. Системная модель роста мышц',
    definition: 'Рост мышц устойчиво происходит, когда совпадают три фактора.',
    bullets: ['механический стимул (силовая нагрузка)', 'аминокислоты (достаточное поступление белка)', 'энергетическая достаточность'],
  },
]

export const MTOR_SITE_UPGRADE = [
  'структурированный научный конспект для сайта',
  'таблицы mTOR / AMPK',
  'схемы сигналов роста',
  'алгоритм максимальной активации mTOR',
  'ошибки, которые тормозят анаболизм',
]
