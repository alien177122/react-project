---
{
  "order": 144,
  "section": "engine",
  "path": "engine-parameters/precision",
...
> Source: [https://animejs.com/documentation/engine/engine-parameters/precision](https://animejs.com/documentation/engine/engine-parameters/precision)
> Breadcrumb: Engine → Engine parameters → precision
...
← Prev: **fps** (`engine/engine-parameters/fps`) | Next: **pauseOnDocumentHidden** (`engine/engine-parameters/pauseondocumenthidden`) →
