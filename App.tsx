...
function VolumeDonut() {
  ...
  // ⚡ Bolt: Consolidated O(N) derived donut calculations (segments, categories, arcs)
  // into a single useMemo loop to prevent redundant iterations on high-frequency hover state changes.
