...
> Source: [https://animejs.com/documentation/timeline/timeline-methods/stretch](https://animejs.com/documentation/timeline/timeline-methods/stretch)
> Breadcrumb: Timeline → Timeline methods → stretch()
...
← Prev: **seek()** (`timeline/timeline-methods/seek`) | Next: **refresh()** (`timeline/timeline-methods/refresh`) →
