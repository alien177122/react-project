...
> Source: [https://animejs.com/documentation/svg/createdrawable](https://animejs.com/documentation/svg/createdrawable)
> Breadcrumb: SVG → createDrawable
...
← Prev: **morphTo** (`svg/morphto`) | Next: **createMotionPath** (`svg/createmotionpath`) →
