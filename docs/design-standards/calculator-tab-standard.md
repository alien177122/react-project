...
### Section rhythm (`.ta-calc-section`)

| Token              | Value                           |
| ------------------ | ------------------------------- |
| Section padding    | 40px 28px (32px 20px ≤760px)    |
| Section separator  | `border-top` между секциями     |
...
| ------------------------------------ | ---------------------------------------- |
| `platforms/legacy-mobile` calculator | RN StyleSheet, другой saved list format  |
| `platforms/macos/CalculatorScreen`   | legacy SectionBlock без apple variant    |
