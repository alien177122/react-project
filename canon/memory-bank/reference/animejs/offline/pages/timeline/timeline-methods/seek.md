...
> Source: [https://animejs.com/documentation/timeline/timeline-methods/seek](https://animejs.com/documentation/timeline/timeline-methods/seek)
> Breadcrumb: Timeline → Timeline methods → seek()
...
← Prev: **revert()** (`timeline/timeline-methods/revert`) | Next: **stretch()** (`timeline/timeline-methods/stretch`) →
