...
Монорепозиторий приложения для **силовой периодизации и тренировок**: веб-клиент (Vite + React 19), общая бизнес-логика (`packages/shared`), Express + SQLite backend. Native / Expo / Capacitor / Electron с 2026-08-27 лежат в `_archive-non-web/` (не удалены).
...
| `ios/`, `android/` | Capacitor native shells над Vite `dist/`                |
| `desktop/`         | Electron entry (`main.cjs`)                             |
