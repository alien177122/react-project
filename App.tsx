...
function VolumeDonut() {
  ...
  const { vol, total, segs, catArcs, catVols } = useMemo(() => {
    // This hook has no reactive dependencies from its scope, meaning it doesn't
    // depend on props or state, computeMuscleVol calculates from EXERCISES which is static.
